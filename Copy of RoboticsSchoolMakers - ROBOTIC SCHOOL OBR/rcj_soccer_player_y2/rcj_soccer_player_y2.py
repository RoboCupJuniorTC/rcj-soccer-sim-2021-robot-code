    ...
    def run(self, counter, score, goal_time, GOAL_FLAG, TIME_FLAG, IMPORT_FLAG, KICK_FLAG):
        ...
        while self.robot.step(rcj_soccer_robot.TIME_STEP) != -1:
            if self.is_new_data():
                ...
                #TRUNCAMENTO_FLAG, CONTANDO_FLAG, BALL_AREA, INICIO = minhas_tarefas.truncamento (data,game_clock, CONTANDO_FLAG, BALL_AREA, INICIO)
                ...
                if ball_pos['x'] * lado > 0.4 and ball_pos['y'] * lado  > 0.35:
                    ...
                    elif robot_pos['x'] * lado  > 0.3 or robot_pos['x'] * lado < 0.2:
                
                        if robot_pos['x'] * lado >  0.37:
                            left_speed  = -10
                            right_speed = -10
                        
                        else:
                            if robot_pos['x'] * lado > 0.3:
                                dir = -1
