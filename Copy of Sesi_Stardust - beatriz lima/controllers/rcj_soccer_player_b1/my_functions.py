...
def stardust_artilheiro(self, data, STOP_NEAR_GOALKEEPER, KICK_FLAG, kick_intensity) -> int:
...
def stardust_goleiro(self, data):
...
def stardust_meu_goleiro(self, data, dist2mygoal):
