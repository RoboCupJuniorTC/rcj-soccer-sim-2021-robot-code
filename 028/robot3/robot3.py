    ...
    def run(self):
        while self.robot.step(TIME_STEP) != -1:
            if self.is_new_data():
                ...
                dist3 = utils.get_dist3(ball_pos, robot_pos)
                ...
                if dist3<.55:
                    if direction == 0: 
                        ...
                        if diff > 180:
                            ...
                            #print('dist3:', dist3, 'left_speed2:', left_speed2, 'right_speed2 :', right_speed2 )
                            ...
                            left_speed= left_speed2
                            right_speed =right_speed2
                            #print('dist3:', dist3,'ball_angle', ball_angle, 'left_speed2:', left_speed2, 'right_speed2 :', right_speed2 )
