...
from team_029_libraries.robot3.rcj_soccer_robot import RCJSoccerRobot, TIME_STEP
from team_029_libraries.robot3 import utils
import math
    ...
    def run(self):
        while self.robot.step(TIME_STEP) != -1:
            if self.is_new_data():
                ...
                if pelota!=3 and dist3<rangodist and aux<0: 
                    if direction == 0: 
                        diff=ball_angle
                        if diff > 180:
                            diff=diff-360
