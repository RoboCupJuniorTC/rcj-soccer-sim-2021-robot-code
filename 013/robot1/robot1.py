...
from team_013_libraries.robot1.rcj_soccer_robot import RCJSoccerRobot, TIME_STEP
from team_013_libraries.robot1 import utils
...
class MyRobot(RCJSoccerRobot):
    def run(self):
        ...
        defender = False #range = .1 (pretty close)
        goalie = True #range = .05 (basically in contact)
