        ...
        while self.robot.step(rcj_soccer_robot.TIME_STEP) != -1:
            if self.is_new_data():
                ...
                if modo_jogo == 'normal':
                    ...
                    if goal == N_ROBOT:
                        ...
                        if ball_pos ["x"] * lado > -0.2:
                            ...
                            if ball_pos ["x"] * lado > 0.6 and (robot_pos['y']* lado  > 0.05 or robot_pos['y']* lado  <-0.05):
                                ...
                                tatu_fc.atacante(self, data, True, KICK_FLAG, 100)
                            else:
                    ...
                    if data[TEAM[1]]['x']*lado > 0.6 and data[TEAM[0]]['x']*lado  > 0.6:
                    ...
                    if ataque[0] == N_ROBOT or segundo:

                        if ball_pos ["x"] * lado > 0.4 or robot_pos['x']*lado > 0.4:
