...
# robot B1 controller
from team_004_libraries.robot1.rcj_soccer_robot import RCJSoccerRobot, TIME_STEP
from team_004_libraries.robot1 import utils
######
    ...
    def run(self):
        ...
        while self.robot.step(TIME_STEP) != -1:
            if self.is_new_data():
                ...
                if (Seite == -1):
                    other_robot_pos = data['B3']
                else:
                    other_robot_pos = data['Y3']
                ...
                if counter > 3:
                    counter = 0
                print ("ball richtung" + str(ball_direction_angle))
                if ((robot_pos['x'] - ball_pos['x'])**2 + (robot_pos['y'] - ball_pos['y'])**2) >  ((other_robot_pos['x'] - ball_pos['x'])**2 + (other_robot_pos['y'] - ball_pos['y'])**2):
                    ...
                    # else:
                    #     if ball_pos['x'] < -0.2:
                    #         if ((ball_pos['x'] < robot_pos['x']) and 2.7 > ball_direction_angle < 3.1):
                    #             drive_pos = ball_pos
                    #         elif ball_pos['y'] < 0:
